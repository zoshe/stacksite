...
var stackPath =jsTagScrS[0];
var sitePath = stackPath.substring(0,stackPath.indexOf("stacksite"));
...
addJS("loader/_/u.js?"+Math.random());
...
//document.write("<sc"+"ript language='JavaScript1.2' type='text/javascript' sr"+"c='"+stackPath+"scripts/1dombuilder/c.js?"+parseInt(jsTagClassNames[7])+"'></sc"+"ript>");
