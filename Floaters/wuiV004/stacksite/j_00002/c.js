...
qssBuildTableFills(objX.qNum, objType, objSubType, 6, objX, 0, "notUsed", "notUsed", objIdArray[7], objParent.qNum, objX.parentSubNum,0); // make the borders for main frame object
...
qssBuildTableFills(objX.qNum, checkType, objSubType, 6, curNavLevObj, pullmenuIsneeded, "notUsed", "notUsed", objIdArray[7], objParent.qNum, objX.parentSubNum,selectIsNeeded); // make the buttons
...
qssBuildTableFills(objX.qNum, objType, objSubType, 6, objX, 0, "notUsed", "notUsed", objIdArray[7], objParent.qNum, objX.parentSubNum,0); // make the borders for the object
...
for(var ii = 0; ii<obj.childQty;ii++){//for2 loop the siblings
...
// the following line worked but it did work in SA because of the table-cell offseteight problem.
