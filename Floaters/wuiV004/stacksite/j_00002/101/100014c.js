...
qssBuildDropMenuBoxes(objParent.parentNode.qNum,9,objSubType,curNavLevObj,selectIsNeeded,objCssSelector);
...
function qssBuildDropMenuBoxes(objQumber,objType,objSubType,curNavLevObj,selectIsNeeded,objCssSelector){
...
(menuBox_Levl > scrollBoxesNeeded)? qssBuildDropMenuBox(qDropMnuDiv,"q"+(objQumber+1),menuBox_Levl,objCssSelector): null; 
