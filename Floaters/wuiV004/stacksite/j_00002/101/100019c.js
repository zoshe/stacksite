...
//100019 var subMB_outer_Pos=qssGetPosElm(subMB_outer);// left and top positions
//100018 var subMB_holder_Pos=qssGetPosElm(subMB_holder);// left and top positions
//100019 var subMB_select_Pos=qssGetPosElm(subMB_select);// left and top positions
...
//100019 subMB_btnT.realtop = subMB_select_Pos[1] - subMB_outer_Pos[1];
...
//100019 subMB_btnB.realtop = first_elm_Height_space - subMB_btnB_Height;
...
var scoMB_outer = qGBID(Scroll_qnumber+"bodymen" + Scroll_Active);
//100019 var scoMB_holder = scoMB_outer.lastChild; // this is the MB_holder
var scoMB_btnT = scoMB_outer.firstChild;
var scoMB_btnB = scoMB_btnT.nextSibling;
var scoMB_select = qGBID(scoMB_outer.openboxid);

//100019 var scoMB_holder_Height = parseInt(scoMB_holder.style.height);
...
var scoMB_select_ClientHeight = parseInt(scoMB_select.clientHeight);
var scoMB_btnT_Height = parseInt(scoMB_btnT.offsetHeight) || 0;
var scoMB_btnB_Height = parseInt(scoMB_btnB.offsetHeight)  || 0;
//100019 var scoMB_select_Tmargin = parseInt(scoMB_select.style.marginTop);
//100019 var scoMB_btnT_Height = (scoMB_btnT.style.display == "none")?0:scoMB_btnT.offsetHeight;
//100019 var scoMB_btnB_Height = (scoMB_btnB.style.display == "none")?0:scoMB_btnB.offsetHeight;
var scrollBtnMouseOffsetBoxTop = parseInt(qssMenuDropScroll_it.scrollBtnMouseOffsetBoxTop) || 0;
//100019 var scoMB_outer_Top = parseInt(scoMB_outer.style.top);
//100019 var scoMB_btnT_mou_elmY = parseInt(qssMenuDropScroll_it.scrollBtnMouseOffsetBoxTop) || 0;
//100019 var scoMB_btnB_mou_elmY = parseInt(qssMenuDropScroll_it.scrollBtnMouseOffsetBoxTop) || 0;
//alert("scoMB_btnB_mou_elmY:"+scoMB_btnB_mou_elmY);
//100019 var scoMB_btnT_mou_elmY = mouse_doc_y - (scoMB_outer_Top + scoMB_btnT.realtop);
//100019 var scoMB_btnB_mou_elmY = mouse_doc_y - (scoMB_outer_Top + scoMB_btnB.realtop);
//alert(scoMB_btnB.getClientRects());
...
//var scroll_it=(Scroll_Direction=="Bot")? (scoMB_select_Tmargin + scoMB_select_Height)-(scoMB_holder_Height):  (scoMB_select_Tmargin < 0)? scoMB_select_Tmargin/-1 :0; scrollTop + clientHeight.
//alert("scoMB_select_ScrollTop:"+scoMB_select_ScrollTop+ "scoMB_select_Height:"+scoMB_select_Height +" scoMB_select_OffsetHeight:"+scoMB_select_OffsetHeight + " scoMB_select_ScrollHeight:"+scoMB_select_ScrollHeight + " scoMB_select_ClientHeight:"+scoMB_select_ClientHeight);
...
//100019 var scroll_it=(Scroll_Direction=="Bot")? (scoMB_select_Tmargin + scoMB_select_Height)-(scoMB_holder_Height):  scoMB_select_Tmargin/-1;
if(scroll_it){
var cleanspeed = (Scroll_Direction=="Bot")? scrollBtnMouseOffsetBoxTop : scoMB_btnT_Height - scrollBtnMouseOffsetBoxTop || 0; // this fixes any negative numbers
//100019 var cleanspeed = (Scroll_Direction=="Bot")? scrollBtnMouseOffsetBoxTop : (scoMB_btnT_Height-scoMB_btnT_mou_elmY >= 1)? scoMB_btnT_Height-scoMB_btnT_mou_elmY : 0; // this fixes any negative numbers
...
// speed = 5;
//alert("speed:"+speed);
//alert("scroll_it:"+scroll_it);
//alert("Scroll_Direction:"+Scroll_Direction);
...
//100019 var scroll_it_again = (Scroll_Direction=="Bot")? ((scoMB_select_Tmargin - speed) + scoMB_select_Height) -  (scoMB_holder_Height) : (scoMB_select_Tmargin + speed)/-1;
//alert(Scroll_Direction + " | " + scoMB_btnT_mou_elmY+ "|"+ scoMB_select_Tmargin + " | " + scroll_it +" | "+scroll_it_again + " | " + speed);

if(scroll_it){
// may want to test scoMB_select_ScrollTop+speed is not greater than scoMB_select_ScrollHeight and place the height of scoMB_select_ScrollHeight if it is..
scoMB_select.scrollTop = (Scroll_Direction=="Bot")? (scoMB_select_ScrollTop+speed < scoMB_select_ScrollHeight)? scoMB_select_ScrollTop+speed : scoMB_select_ScrollHeight :  scoMB_select_ScrollTop - speed || 0;
 // sa hates setting top button to 0px but it can go to -1px first than 0px
//100019 scoMB_select.style.marginTop = (Scroll_Direction=="Bot")? scoMB_select_Tmargin - speed + "px" : (scoMB_select_Tmargin+speed!=0 || scoMB_select_Tmargin==-1)? scoMB_select_Tmargin+speed+"px" : "-1px"; // sa hates setting top button to 0px but it can go to -1px first than 0px
}
...
//100019 var evt = (elm)? elm : top.event; // qWin.event; this may be needed for windows ie and other browser and added of course to the mix
//100019 qssGetPosAll(evt, this); // this function produces and sets the positioning cords var for the scroll buttons
}
