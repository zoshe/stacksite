...
else if(objType==4 || objType==20 || objType==50 || objType==7){
//4-Box, 7-Page, 20-menuBox, 50-crumbBox
...
var spaceName = (objType==4)? "Box": (objType==20)? "menuBox" : (objType==7)?"Page":"CrumbBox";
...
else if(objType==90){ // content object needs to go here
alert("snipit90");
