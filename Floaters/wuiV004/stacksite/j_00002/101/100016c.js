...
qssBuildDropMenuBoxes(objParent.parentNode.qNum,9,objSubType,curNavLevObj,selectIsNeeded,curParentCssSelector);
...
function qssBuildDropMenuBoxes(objQumber,objType,objSubType,curNavLevObj,selectIsNeeded,curParentCssSelector){
...
d0.setAttribute("trace","groupBox"); // just here to help me find this div during development , it can be removed on final build
d0.setAttribute("zs","_diBo_boSiBo_boOrVe");
...
d00.setAttribute("zs","_diBo_boSiBo_boOrVe_poAb_cuPo_allSizesAuto");
...
(objCssSelector)? d00.setAttribute("zs",objCssSelector.replace(".","menuBox")) : null;
...
subMB_outer.className = "qDmnuSizer " +subMB_select_qNum+"cmenuBox"; // I think menuBox is ready to get out of here, absolute and display none could be put on the build div// I moved menuBlock to the div, I'm keeping it here it only here now to help with code testing
...
subMB_outer.className = "noneMB "+subMB_select_qNum+"cmenuBox";
...
///var objNumber = parseInt(objID.substring(1)); // The Object's Number, the number that follows the q . i.e. 5 or 9 or etc.
var objChangeX = objX; // this id the first div or the td
